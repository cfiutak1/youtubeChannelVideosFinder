...
def generate_parser():
    ...
    arg_parser = add_api_key_arg(arg_parser)
    arg_parser = add_channel_id_arg(arg_parser)
    arg_parser = add_output_file_path_arg(arg_parser)
    arg_parser = add_log_file_path_arg(arg_parser)
    arg_parser = add_date_range_args(arg_parser)
    arg_parser = add_interval_arg(arg_parser)
    arg_parser = add_output_detail_args(arg_parser)
